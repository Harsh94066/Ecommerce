                ...
                <div className="col-md-10 mt-2">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <input
                                type="text" className='form-control' onChange={e => setName(e.target.value)}
                                value={name}
                                autoFocus
                                required
                            />
                        ...
                        <div className="form-group">
                            ...
                            <input
                                type="text" className='form-control' onChange={e => setDiscount(e.target.value)}
                                value={discount}
                                required
                            />
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <DatePicker
                                className='form-control' selected={expiry}
                                value={expiry}
